...
import {Book, BookService} from '../../book-mgmt/book.service';

@Component({
  selector: 'app-change-suggestion-details',
  templateUrl: './change-suggestion-details.component.html',
  styleUrls: ['./change-suggestion-details.component.scss']
})
export class ChangeSuggestionDetailsComponent implements OnInit {
  ...
  getErrorMessageOfField(fieldName: string): string {
    if (this.isFieldInvalid(fieldName)) {
      ...
      return ChangeSuggestionDetailsComponent.createErrorMessage(fieldControl.errors);
    }
  }
