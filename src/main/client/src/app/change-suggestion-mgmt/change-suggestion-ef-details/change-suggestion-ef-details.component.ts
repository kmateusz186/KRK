...
@Component({
  selector: 'app-change-suggestion-ef-details',
  templateUrl: './change-suggestion-ef-details.component.html',
  styleUrls: ['./change-suggestion-ef-details.component.scss']
})
export class ChangeSuggestionEfDetailsComponent implements OnInit {
