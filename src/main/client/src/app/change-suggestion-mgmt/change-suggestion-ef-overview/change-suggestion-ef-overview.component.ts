...
@Component({
  selector: 'app-change-suggestion-ef-overview',
  templateUrl: './change-suggestion-ef-overview.component.html'
})
export class ChangeSuggestionEfOverviewComponent implements OnInit {
