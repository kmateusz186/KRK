...
@Component({
  selector: 'app-education-program-edit-details',
  templateUrl: './education-program-edit-details.component.html',
  styleUrls: ['./education-program-edit-details.component.scss']
})
export class EducationProgramEditDetailsComponent implements OnInit {
